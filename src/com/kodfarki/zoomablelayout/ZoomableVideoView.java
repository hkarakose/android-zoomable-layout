...
public class ZoomableVideoView extends TextureView implements MediaPlayerControl{

    private static final String LOG_TAG = "ZoomableVideoView";
    ...
    // currentState is a ZoomableVideoView object's current state.
    // targetState is the state that a method caller intends to reach.
    // For instance, regardless the ZoomableVideoView object's current state,
    ...
    public ZoomableVideoView(final Context context) {
        super(context);
        mContext = context;
        initVideoView();
    }

    public ZoomableVideoView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initVideoView();
    }
